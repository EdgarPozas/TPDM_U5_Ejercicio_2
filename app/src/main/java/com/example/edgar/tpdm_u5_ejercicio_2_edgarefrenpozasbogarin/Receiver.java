package com.example.edgar.tpdm_u5_ejercicio_2_edgarefrenpozasbogarin;
...
public class Receiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(contenido.startsWith("HISTORIA")){
            ...
            if(_argumentos.length==2){
                ...
                if(__argumentos.length==2){
                    String municipio= __argumentos[0];
                    ...
                    String query="select "+(lenguaje.equals("es")?"español":"ingles")+" from respuestas where municipio='"+municipio+"'";
